...
class ContentImportByConventionElement extends ContentBasicElement {
    ...
    constructor() {
        ...
        this.description = `
            ...
            <pre class="ui segment">&lt;a is="router-link" href="(main:content-import-byconvention(/routing-wc/examples/named-outlet/content-import-byconvention.js))"&gt;Import By Convention&lt;/a&gt;</pre><br>
            <p>
            ...
            <pre class="ui segment">&lt;a is="router-link" href="(main:/routing-wc/examples/named-outlet/content-import-byconvention)"&gt;Import By Convention&lt;/a&gt;</pre><br>
            <p>
